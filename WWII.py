...
if ans1 == 'b':
    ...
    time.sleep(1)
    print(line)
ans2 = input(str(questions[1]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[5]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[6]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[1]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[20]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'c':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)
ans2 = input(str(questions[2]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[4]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[6]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[7]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[2]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'd':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)
ans2 = input(str(questions[3]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[3]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[9]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[12]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[15]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'a':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[4]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[11]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[15]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[4]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[8]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'c':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[5]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[17]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[5]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[20]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[2]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'b':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[6]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[9]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[15]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[7]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[6]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'd':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[7]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[7]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[18]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[4]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[19]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'a':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[8]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[3]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[8]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[14]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[10]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'b':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[9]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[9]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[15]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[1]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[14]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'a':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[10]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[20]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[15]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[13]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[10]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'd':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[11]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[0]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[15]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[11]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[9]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'c':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[12]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[12]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[6]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[19]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[15]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'a':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[13]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[4]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[12]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[13]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[8]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'c':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[14]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[5]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[14]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[12]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[6]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'b':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[15]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[0]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[8]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[3]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[15]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'd':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[16]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[0]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[16]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[0]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[0]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'b':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[17]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[17]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[0]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[0]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[0]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'a':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[18]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[18]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[15]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[10]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[2]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'a':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)  
ans2 = input(str(questions[19]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[3]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[19]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[0]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[11]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'b':
    points += 1
    print('')
    print('Correct!')
    ...
    time.sleep(1)
    print(line)
ans2 = input(str(questions[20]).lstrip('[\'').rstrip('\']')+'\na) '+str(definitions[6]).lstrip('[\'').rstrip('\']')+'\nb) '+str(definitions[15]).lstrip('[\'').rstrip('\']')+'\nc) '+str(definitions[4]).lstrip('[\'').rstrip('\']')+'\nd) '+str(definitions[20]).lstrip('[\'').rstrip('\']')+'\n')
if ans2 == 'd':
    points += 1
    print('')
    print('Correct!')
